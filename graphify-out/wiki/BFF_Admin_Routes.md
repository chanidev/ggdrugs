...
- **event-reviews.ts** (6 connections) — `apps\bff\src\routes\event-reviews.ts`
...
- **admin-documents.ts** (2 connections) — `apps\bff\src\routes\admin-documents.ts`
- **chat.ts** (2 connections) — `apps\bff\src\routes\chat.ts`
- **event-detail.ts** (2 connections) — `apps\bff\src\routes\event-detail.ts`
- **events-stats.ts** (2 connections) — `apps\bff\src\routes\events-stats.ts`
...
- `apps\bff\src\routes\event-reviews.ts`
