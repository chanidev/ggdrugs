...
- 후속 (v5 후보 잔여):
  ...
  - **거리순 anchor 확장** — Kakao Places 검색 (지오코딩 통합) / multi-region centroid (mean / convex hull) UX 결정.
